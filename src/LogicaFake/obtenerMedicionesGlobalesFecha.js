//--------------------------------------------
/**
 * obtenerMedicionesGlobalesFecha.js
 ...
 */
function obtenerMedicionesGlobalesFecha(cb,fecha){
    ...
    xmlhttp.open("GET", "http://localhost:5000/obtenerMedicionesGlobalesFecha?fecha="+fecha, true)
